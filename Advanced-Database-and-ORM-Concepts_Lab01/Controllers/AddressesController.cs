...
namespace Advanced_Database_and_ORM_Concepts_Lab01.Controllers
{
    public class AddressesController : Controller
    {
        ...
        public AddressesController(Advanced_Database_and_ORM_Concepts_Lab01Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Advanced_Database_and_ORM_Concepts_Lab01Context.Address'  is null.");
            }
            var address = await _context.Address.FindAsync(id);
            if (address != null)
            {
